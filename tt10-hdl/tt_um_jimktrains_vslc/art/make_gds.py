...
# Script taken from:
#   https://github.com/RebeccaRGB/tt09ball-gdsart/blob/main/art/make_gds.py
# Following instructions from:
#   https://docs.google.com/document/d/1Ll64tvDcXpNJ4eiEX2WIENWlGGORSkXifmeXCHYlONU/edit?tab=t.0
