...
color=16
node=vin1}
B 2 1725 -320 2355 -40 {flags=graph,unlocked
...
B 2 1730 -670 2360 -390 {flags=graph,unlocked
...
T {M} 1710 -278.2032212772847 0 1 0.6 0.6 { layer=3}
N 370 -630 370 -590 {
lab=V1}
N 370 -410 370 -390 {
lab=#net1}
N 370 -530 370 -470 {
lab=V2}
N 230 -460 330 -460 {lab=Vin1}
N 330 -460 330 -360 {lab=Vin1}
N 330 -560 330 -520 {lab=#net2}
N 470 -490 560 -490 {lab=#net3}
N 370 -490 410 -490 {lab=V2}
N 1070 -490 1150 -490 {lab=Vout}
N -260 -420 -230 -420 {
lab=VSS}
N -260 -590 -230 -590 {
lab=VDD}
...
N 560 -490 590 -490 {lab=#net3}
N 850 -430 850 -410 {lab=VSS}
N 370 -330 370 -310 {lab=VSS}
N 590 -490 610 -490 {lab=#net3}
N 850 -490 1070 -490 {lab=Vout}
N 670 -490 850 -490 {lab=Vout}
N 380 -360 380 -330 {lab=VSS}
N 370 -330 380 -330 {lab=VSS}
N 370 -360 380 -360 {lab=VSS}
N 370 -560 380 -560 {lab=V1}
N 380 -590 380 -560 {lab=V1}
N 370 -590 380 -590 {lab=V1}
N 370 -710 370 -690 {lab=VDD}
C {lab_pin.sym} 370 -710 2 0 {name=p8 lab=VDD}
C {lab_pin.sym} 1150 -490 0 1 {name=p11 lab=Vout}
C {ammeter.sym} 370 -440 0 1 {name=vi_i2}
C {ngspice_get_value.sym} 360 -310 0 1 {name=r2 node=@$\{path\}m2[gm]
descr="gm="}
C {ngspice_get_value.sym} 360 -590 0 1 {name=r1 node=@$\{path\}m1[gm]
descr="gm="}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 350 -560 0 0 {name=M1
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8_lvt
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 350 -360 0 0 {name=M2
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8_lvt
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 850 -460 0 0 {name=C1 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
C {ammeter.sym} 330 -490 0 1 {name=vi_i1}
C {ammeter.sym} 440 -490 3 1 {name=vi_i3}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 640 -490 3 0 {name=R10
W=0.35
L=10000
model=res_xhigh_po_0p35
spiceprefix=X
 mult=1}
C {lab_pin.sym} 230 -460 2 1 {name=p1 lab=Vin1}
...
C {devices/lab_pin.sym} 370 -310 2 0 {name=p2 lab=VSS}
C {devices/lab_pin.sym} 850 -410 2 0 {name=p3 lab=VSS}
C {devices/lab_pin.sym} 640 -470 2 0 {name=p4 lab=VSS}
