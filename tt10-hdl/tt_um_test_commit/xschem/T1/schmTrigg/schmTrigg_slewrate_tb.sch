...
B 2 1730 -965 2360 -685 {flags=graph,unlocked
...
T {Transient Analysis} 1725 -1250 0 0 0.6 0.6 { layer=6}
...
N 910 -450 910 -380 {lab=Vout}
N 450 -390 450 -300 {lab=Vjump}
N 370 -560 450 -560 {lab=Vjump}
N 450 -470 450 -390 {lab=Vjump}
N 450 -700 450 -640 {lab=Vjump}
N 450 -800 470 -800 {lab=Vjump}
N 450 -700 470 -700 {lab=Vjump}
N 650 -870 650 -830 {lab=#net1}
N 650 -270 650 -260 {lab=#net2}
N 650 -360 650 -330 {lab=V2}
N 450 -300 470 -300 {lab=Vjump}
N 650 -370 650 -360 {lab=V2}
...
N 470 -700 610 -700 {lab=Vjump}
N 470 -300 610 -300 {lab=Vjump}
N 470 -400 610 -400 {lab=Vjump}
N 910 -540 910 -450 {lab=Vout}
N 450 -560 450 -470 {lab=Vjump}
N 650 -750 650 -730 {lab=V1}
N 650 -750 880 -750 {lab=V1}
N 880 -750 950 -750 {lab=V1}
N 910 -550 910 -540 {lab=Vout}
N 650 -350 950 -350 {lab=V2}
N 950 -430 950 -410 {lab=#net3}
N 950 -690 950 -670 {lab=#net4}
N 650 -770 650 -750 {lab=V1}
N 450 -800 450 -700 {lab=Vjump}
N 650 -550 650 -430 {lab=Vout}
N 650 -670 650 -550 {lab=Vout}
N 450 -640 450 -560 {lab=Vjump}
N 910 -720 910 -550 {lab=Vout}
N 830 -770 830 -750 {lab=V1}
N 830 -370 830 -350 {lab=V2}
N 910 -550 980 -550 {lab=Vout}
N 1040 -550 1090 -550 {lab=Vout}
...
N -240 -420 -240 -400 {lab=#net7}
N -240 -500 -240 -480 {lab=VDD}
N 950 -510 950 -490 {lab=VDD}
N 950 -610 950 -590 {lab=0}
N 650 -950 650 -930 {lab=VDD}
N 650 -190 650 -170 {lab=0}
...
C {simulator_commands.sym} -500 -830 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=true 
value="
.temp 30
...
C {devices/code.sym} -500 -680 0 0 {name=TT_MODELS
only_toplevel=true
...
C {devices/vsource.sym} -240 -370 0 0 {name=vs_vdd value=1.8}
C {devices/lab_pin.sym} -240 -500 2 0 {name=p32 lab=VDD}
C {devices/lab_pin.sym} -240 -340 0 0 {name=p33 lab=0}
C {launcher.sym} -570 -1010 0 0 {name=h1
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {launcher.sym} -645 -1050 0 0 {name=h2 
descr="Load DC" 
tclcommand="
xschem raw_read $netlist_dir/schmTriggTran.raw dc
"
}
C {launcher.sym} -700 -1180 0 0 {name=h3 
descr="Load AC" 
tclcommand="
xschem raw_read $netlist_dir/schmTriggTran.raw ac
"
}
C {launcher.sym} -675 -1140 0 0 {name=h4
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {launcher.sym} -250 -1002.5 0 0 {name=h5 
descr="Load TRAN" 
tclcommand="
xschem raw_read $netlist_dir/schmTriggTran.raw tran
"
}
C {launcher.sym} -175 -972.5 0 0 {name=h9
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {devices/lab_pin.sym} 1190 -550 2 0 {name=p86 lab=Vout
}
C {devices/lab_pin.sym} 950 -510 2 0 {name=p87 lab=VDD
}
C {devices/lab_pin.sym} 830 -770 2 0 {name=p9 lab=V1}
C {devices/lab_pin.sym} 830 -370 2 0 {name=p14 lab=V2}
C {devices/lab_pin.sym} 650 -170 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} 950 -590 2 0 {name=p2 lab=0}
C {sky130_fd_pr/nfet_01v8.sym} 930 -380 0 0 {name=M1
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 630 -300 0 0 {name=M2
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 930 -720 0 0 {name=M4
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 630 -800 0 0 {name=M6
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {lab_pin.sym} -270 -640 0 0 {name=p3 lab=0}
C {vsource.sym} -270 -670 0 0 {name=VIN3
value="0 pulse 0 1.8 1n 0.001n 0.001n 3n 6n ac 1 0" 

}
C {lab_pin.sym} -270 -880 0 1 {name=p6 lab=Vjump
}
C {ammeter.sym} -270 -830 2 1 {name=vi_ig}
C {res.sym} -270 -750 0 0 {name=R2
value=30
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 370 -560 2 1 {name=p4 lab=Vjump
}
C {ammeter.sym} -240 -450 2 1 {name=vi_id}
C {devices/lab_pin.sym} 650 -950 2 0 {name=p5 lab=VDD}
C {ammeter.sym} 950 -460 0 0 {name=vi_id1}
