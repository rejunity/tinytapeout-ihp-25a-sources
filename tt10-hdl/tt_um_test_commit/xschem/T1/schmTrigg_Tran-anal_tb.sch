...
hcursor2_y=0.70381108
hcursor1_y=1.1438962}
...
N 450 -390 450 -300 {lab=Vin}
N 370 -560 450 -560 {lab=Vin}
N 450 -470 450 -390 {lab=Vin}
N 450 -700 450 -640 {lab=Vin}
N 450 -800 470 -800 {lab=Vin}
N 450 -700 470 -700 {lab=Vin}
N 650 -870 650 -830 {lab=VDD}
N 650 -270 650 -260 {lab=0}
N 650 -360 650 -330 {lab=V2}
N 450 -300 470 -300 {lab=Vin}
N 650 -370 650 -360 {lab=V2}
N 450 -400 470 -400 {lab=Vin}
...
N 470 -700 610 -700 {lab=Vin}
N 470 -300 610 -300 {lab=Vin}
N 470 -400 610 -400 {lab=Vin}
N 910 -540 910 -450 {lab=Vout}
N 450 -560 450 -470 {lab=Vin}
...
C {devices/lab_pin.sym} 650 -870 2 0 {name=p83 lab=VDD
}
C {devices/lab_pin.sym} 370 -560 2 1 {name=p85 lab=Vin
}
C {devices/lab_pin.sym} 1190 -550 2 0 {name=p86 lab=Vout
}
C {devices/lab_pin.sym} 950 -430 2 0 {name=p87 lab=VDD
}
C {devices/lab_pin.sym} 830 -770 2 0 {name=p9 lab=V1}
C {devices/lab_pin.sym} 830 -370 2 0 {name=p14 lab=V2}
C {devices/lab_pin.sym} 650 -250 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} 950 -670 2 0 {name=p2 lab=0}
C {devices/vsource.sym} -260 -670 0 0 {name=vs_sin 
value="sin(0.9 0.9 1 0.5)"
*SIN(Offset Amplitude Frequency Delay DampingFactor Phase)}
