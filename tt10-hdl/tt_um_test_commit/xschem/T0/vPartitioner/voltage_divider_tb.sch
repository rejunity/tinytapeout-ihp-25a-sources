...
N -200 -770 -200 -740 {lab=Vin}
N -200 -770 -140 -770 {lab=Vin}
N -200 -950 -200 -920 {lab=Vdd}
N -200 -950 -140 -950 {lab=Vdd}
N 140 -680 200 -680 {lab=Vin}
N 260 -680 320 -680 {lab=Vin}
N 380 -680 440 -680 {lab=Vout}
N 500 -680 530 -680 {lab=0}
N 530 -680 530 -650 {lab=0}
N 320 -680 330 -680 {lab=Vin}
N 360 -680 380 -680 {lab=Vout}
N 230 -680 260 -680 {lab=Vin}
N 470 -680 500 -680 {lab=0}
N 200 -680 230 -680 {lab=Vin}
N 360 -720 460 -720 {lab=Vdd}
N 460 -720 470 -720 {lab=Vdd}
N 420 -780 420 -720 {lab=Vdd}
...
C {devices/lab_pin.sym} 530 -650 2 0 {name=p10 lab=0}
C {devices/vsource.sym} -200 -710 0 0 {name=vs_vin value=1}
C {devices/lab_pin.sym} -200 -680 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} -140 -770 2 0 {name=p3 lab=Vin}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 360 -700 3 1 {name=M2
L=1
W=3
nf=1 mult=1
model=nfet_01v8_lvt
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 470 -700 3 1 {name=M1
L=1.5
W=2
nf=1 mult=1
model=nfet_01v8_lvt
...
C {devices/vsource.sym} -200 -890 0 0 {name=vs_vdd value=1.8}
C {devices/lab_pin.sym} -200 -860 0 0 {name=p2 lab=0}
C {devices/lab_pin.sym} -140 -950 2 0 {name=p5 lab=Vdd}
C {devices/lab_pin.sym} 420 -780 1 0 {name=p6 lab=Vdd}
C {devices/lab_pin.sym} 140 -680 0 0 {name=p8 lab=Vin}
C {devices/lab_pin.sym} 410 -680 3 0 {name=p4 lab=Vout}
