...
B 2 -110 -880 27 -820 {flags=image
alpha=0.6
InvertOnExport=true
...
T {tcleval(Power: [to_eng [xschem raw value power 0]]W)} 120 -1080 0 0 0.4 0.4 {floater=-1 layer=15}
T {Example of ways to pull 
user parameters from .raw file:
} 120 -1170 0 0 0.4 0.4 { layer=15}
T {Power: @spice_get_voltage(power)\\W} 120 -1050 0 0 0.4 0.4 {floater=true layer=15}
...
T {Supply Voltage: @spice_get_voltage(vcc)\\V} 910 -1000 0 0 0.4 0.4 {floater=true layer=15}
T {tcleval(Power: [to_eng [xschem raw value power 0]]W)} 910 -1030 0 0 0.4 0.4 {floater=-1 layer=15}
T {			Circuit Information
__________________________________________________} 770 -1100 0 0 0.4 0.4 { layer=15}
...
N -110 -590 -80 -590 {
lab=Vin2}
N 1150 -420 1160 -420 {lab=Vout}
N 400 -420 450 -420 {lab=#net1}
N 510 -420 520 -420 {lab=#net2}
N 1110 -420 1150 -420 {lab=Vout}
N 980 -420 1110 -420 {lab=Vout}
N 1160 -420 1190 -420 {lab=Vout}
N 1190 -420 1250 -420 {lab=Vout}
N 375 -420 400 -420 {lab=#net1}
N 630 -420 670 -420 {lab=#net3}
N 625 -420 630 -420 {lab=#net3}
N 1080 -420 1080 -390 {lab=Vout}
N 1080 -330 1080 -310 {lab=#net4}
N 1240 -420 1240 -390 {lab=Vout}
N 1240 -330 1240 -310 {lab=#net5}
N 980 -330 980 -310 {lab=#net6}
N 980 -420 980 -390 {lab=Vout}
N 520 -420 570 -420 {lab=#net2}
N 940 -420 980 -420 {lab=Vout}
N 930 -420 940 -420 {lab=Vout}
N 750 -420 790 -420 {lab=#net7}
N 745 -420 750 -420 {lab=#net7}
N 670 -420 690 -420 {lab=#net3}
N 870 -420 910 -420 {lab=Vout}
N 865 -420 870 -420 {lab=Vout}
N 790 -420 810 -420 {lab=#net7}
N 910 -420 930 -420 {lab=Vout}
N 290 -420 300 -420 {lab=#net8}
C {lab_pin.sym} -110 -220 0 0 {name=p17 lab=0}
C {vsource.sym} -110 -250 0 0 {name=VVCC value='VCC'
}
C {lab_pin.sym} -80 -310 0 1 {name=p2 lab=VCC}
C {lab_pin.sym} -110 -350 0 0 {name=p14 lab=0}
C {vsource.sym} -110 -380 0 0 {name=VIN1
value="1.8 pulse 0 1.8 1n 1n 1n 39.999m 80m ac 1 0" 

}
C {lab_pin.sym} -80 -440 0 1 {name=p15 lab=Vin1}
C {lab_pin.sym} -110 -500 0 0 {name=p16 lab=0}
C {vsource.sym} -110 -530 0 0 {name=VIN2 value=1.4}
C {lab_pin.sym} -80 -590 0 1 {name=p18 lab=Vin2}
C {launcher.sym} 1250 -615 0 0 {name=h1
descr=Backannotate
...
C {launcher.sym} 1200 -730 0 0 {name=h3 
...
C {simulator_commands.sym} -350 -550 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=true 
value="
.temp 30
...
C {devices/code.sym} -280 -130 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {ammeter.sym} 480 -420 3 1 {name=vi_total}
...
C {lab_pin.sym} 1250 -420 2 0 {name=p5 lab=Vout}
C {launcher.sym} 1245 -550 0 0 {name=h9
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_expr.sym} 730 -730 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)]\}]"
descr="Voltage drop at Resistor ="}
C {ngspice_get_expr.sym} 730 -640 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)])/ [ngspice::get_voltage i(vi_total)]\}]]"
descr="Resistance ="}
C {ngspice_get_expr.sym} 730 -690 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_total)]]"
descr="Current through Resistor ="}
C {ammeter.sym} 1080 -360 0 1 {name=vi_r
}
C {lab_pin.sym} 980 -250 0 0 {name=p1 lab=0}
C {lab_pin.sym} 1240 -250 0 0 {name=p3 lab=0}
C {ammeter.sym} 1240 -360 0 1 {name=vi_c2
}
C {lab_pin.sym} 1080 -250 0 0 {name=p4 lab=0}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1240 -280 0 0 {name=C3 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 980 -280 0 0 {name=C1 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
C {ammeter.sym} 980 -360 0 1 {name=vi_c1
}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 1080 -280 0 0 {name=R10
W=0.35
L=1.75
model=res_xhigh_po_0p35
spiceprefix=X
 mult=1}
C {lab_pin.sym} 1060 -220 0 0 {name=p7 lab=0}
C {ammeter.sym} 1060 -250 0 1 {name=vi_r1
}
C {sky130_fd_pr/nfet_01v8.sym} 600 -440 1 0 {name=M1
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8
...
C {ammeter.sym} 600 -490 2 1 {name=vi_c3
}
C {ammeter.sym} 600 -390 2 1 {name=vi_c4
}
C {lab_pin.sym} 600 -360 0 0 {name=p6 lab=0}
C {lab_pin.sym} 600 -520 2 1 {name=p8 lab=VCC}
C {sky130_fd_pr/nfet_01v8.sym} 720 -440 1 0 {name=M2
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8
...
C {ammeter.sym} 720 -490 2 1 {name=vi_c5
}
C {ammeter.sym} 720 -390 2 1 {name=vi_c6
}
C {lab_pin.sym} 720 -360 0 0 {name=p9 lab=0}
C {lab_pin.sym} 720 -520 2 1 {name=p10 lab=VCC}
C {sky130_fd_pr/nfet_01v8.sym} 840 -440 1 0 {name=M3
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8
...
C {ammeter.sym} 840 -490 2 1 {name=vi_c7
}
C {ammeter.sym} 840 -390 2 1 {name=vi_c8
}
C {lab_pin.sym} 840 -360 0 0 {name=p11 lab=0}
C {lab_pin.sym} 840 -520 2 1 {name=p12 lab=VCC}
C {sky130_stdcells/inv_1.sym} 250 -420 0 0 {name=x1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 340 -420 0 0 {name=x2 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {lab_pin.sym} 210 -420 2 1 {name=p13 lab=Vin1}
