...
B 2 1460 -735 2090 -455 {flags=graph,unlocked
...
color=7
node=v(vout)}
B 2 1460 -918.2032212772845 2090 -798.2032212772845 {flags=graph,unlocked
...
color=16
node=vin1}
B 2 1460 -440 2090 -160 {flags=graph,unlocked
...
T {Resistance: (@spice_get_voltage(vin_eff)\\V - @spice_get_voltage(vout)\\V)  } 630 -845 0 0 0.4 0.4 {floater=true layer=15}
...
} 2845 -1570 0 0 0.4 0.4 { layer=15}
...
T {For known waveforms} 1800 -963.2032212772845 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1835 -783.2032212772845 0 1 0.6 0.6 { layer=3}
N 750 -390 810 -390 {lab=#net1}
N 860 -390 890 -390 {lab=Vout}
N 890 -390 970 -390 {lab=Vout}
N 430 -390 470 -390 {lab=Vin1}
N 670 -390 750 -390 {lab=#net1}
N 40 -250 70 -250 {
lab=Vss}
N 220 -250 250 -250 {
lab=Vdd}
N 50 -580 80 -580 {
lab=Vin1}
N 80 -580 130 -580 {lab=Vin1}
N 250 -250 300 -250 {lab=Vdd}
N 70 -250 100 -250 {lab=Vss}
N 910 -390 910 -370 {lab=Vout}
N 910 -310 910 -270 {lab=Vss}
N 430 -530 430 -390 {lab=Vin1}
N 470 -390 610 -390 {lab=Vin1}
C {lab_pin.sym} 50 -460 0 0 {name=p14 lab=0}
C {vsource.sym} 50 -490 0 0 {name=VIN1
value="0 pulse 0 1.8 1m 1n 1n 39.999m 80m ac 1 0" 
...
C {launcher.sym} 1200 -740 0 0 {name=h3 
descr="Load waveforms" 
tclcommand="
xschem raw_read $netlist_dir/template_adv_tb.raw tran
"
}
C {launcher.sym} 2290 -1300 0 0 {name=h4
...
C {devices/code.sym} -130 -120 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {launcher.sym} 2600 -1375 0 0 {# his is a button "launcher.sym" from "/xschem/xschem_library/devices" 
name=h999
descr="Auto center 
--> F"
tclcommand \{
...
C {launcher.sym} 2600 -1305 0 0 {# his is a button "launcher.sym" from "/xschem/xschem_library/devices" 
name=h6
...
C {launcher.sym} 2600 -1215 0 0 {# his is a button "launcher.sym" from "/xschem/xschem_library/devices" 
name=h7
...
C {launcher.sym} 1245 -560 0 0 {name=h9
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_expr.sym} 800 -780 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)]\}]"
descr="Voltage drop at Resistor ="}
C {ngspice_get_expr.sym} 800 -690 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)])/ [ngspice::get_voltage i(vi_total)]\}]]"
descr="Resistance ="}
C {ngspice_get_expr.sym} 800 -740 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_total)]]"
descr="Current through Resistor ="}
C {res.sym} 835 -390 3 0 {name=R9
value=10000
footprint=1206
device=resistor
m=1}
C {ammeter.sym} 640 -390 3 1 {name=vi_cap}
C {ngspice_get_value.sym} 560 -650 0 1 {name=r1 node=@$\{path\}m1[gm]
descr="gm="}
C {devices/vsource.sym} 40 -160 0 0 {name=VVSS value=0}
C {devices/lab_pin.sym} 40 -250 0 0 {name=p7 lab=Vss}
C {devices/lab_pin.sym} 40 -130 0 0 {name=p8 lab=0}
C {devices/res.sym} 40 -220 0 0 {name=R2
value=30
footprint=1206
device=resistor
m=1}
C {devices/parax_cap.sym} 100 -240 0 0 {name=C6 gnd=0 value=100p m=1}
C {devices/vsource.sym} 220 -160 0 0 {name=VVCC1 value='VCC'}
C {devices/lab_pin.sym} 220 -250 0 0 {name=p32 lab=Vdd}
C {devices/lab_pin.sym} 220 -130 0 0 {name=p33 lab=0}
C {devices/res.sym} 220 -220 0 0 {name=R10
value=30
footprint=1206
device=resistor
m=1}
C {devices/parax_cap.sym} 300 -240 0 0 {name=C11 gnd=0 value=100p m=1}
C {devices/res.sym} 50 -550 0 0 {name=R3
value=30
footprint=1206
device=resistor
m=1}
C {devices/parax_cap.sym} 130 -570 0 0 {name=C1 gnd=0 value=5f m=1}
C {lab_pin.sym} 50 -580 2 1 {name=p6 lab=Vin1}
C {sky130_fd_pr/cap_mim_m3_1.sym} 910 -340 0 0 {name=C2 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 910 -270 2 0 {name=p5 lab=Vss}
C {lab_pin.sym} 970 -390 2 0 {name=p2 lab=Vout}
C {lab_pin.sym} 430 -530 2 1 {name=p3 lab=Vin1}
