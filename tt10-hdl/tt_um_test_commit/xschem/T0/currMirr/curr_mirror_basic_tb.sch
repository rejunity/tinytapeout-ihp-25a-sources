...
S {}
E {}
B 2 -560 -430 -423 -370 {flags=image
alpha=0.6
InvertOnExport=true
...
B 2 747.5 -937.5 1377.5 -657.5 {flags=graph
...
autoload=1
xrawfile=$netlist_dir/cmos_example_ngspice.raw}
B 2 750 -1118.203221277284 1380 -998.203221277284 {flags=graph,unlocked
...
color=16
node=vin1}
B 2 750 -640 1380 -360 {flags=graph
...
T {Transient Analysis} 745 -1232.5 0 0 0.6 0.6 { layer=6}
...
T {For known waveforms} 1090 -1173.203221277284 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1125 -993.203221277284 0 1 0.6 0.6 { layer=3}
...
N -190 -660 -190 -630 {lab=VREF}
N -190 -660 -130 -660 {lab=VREF}
N -190 -520 -190 -490 {lab=VDD}
N -190 -520 -130 -520 {lab=VDD}
N -190 -810 -190 -780 {lab=Vgs}
N -190 -810 -130 -810 {lab=Vgs}
N 280 -910 280 -840 {lab=VDD_jump}
N 210 -840 280 -840 {lab=VDD_jump}
N 210 -840 210 -820 {lab=VDD_jump}
N 280 -840 340 -840 {lab=VDD_jump}
N 340 -840 340 -820 {lab=VDD_jump}
N 250 -790 300 -790 {lab=#net1}
N 340 -790 350 -790 {lab=VDD_jump}
N 350 -820 350 -790 {lab=VDD_jump}
N 340 -820 350 -820 {lab=VDD_jump}
N 200 -790 210 -790 {lab=VDD_jump}
N 200 -820 200 -790 {lab=VDD_jump}
N 200 -820 210 -820 {lab=VDD_jump}
N 210 -630 210 -580 {lab=#net2}
N 250 -550 300 -550 {lab=#net2}
N 270 -600 270 -550 {lab=#net2}
N 210 -600 270 -600 {lab=#net2}
N 270 -790 270 -740 {lab=#net1}
N 270 -740 340 -740 {lab=#net1}
N 340 -630 340 -580 {lab=#net3}
N 210 -520 210 -500 {lab=0}
N 340 -520 340 -500 {lab=#net4}
N 340 -440 340 -420 {lab=0}
N 210 -760 210 -630 {lab=#net2}
N 340 -760 340 -690 {lab=#net1}
N 200 -550 210 -550 {lab=0}
N 200 -550 200 -520 {lab=0}
N 200 -520 210 -520 {lab=0}
N 340 -550 350 -550 {lab=#net4}
N 350 -550 350 -520 {lab=#net4}
N 340 -520 350 -520 {lab=#net4}
N 340 -690 470 -690 {lab=#net1}
N 470 -630 470 -610 {lab=0}
N -190 -920 -90 -920 {lab=VDD_jump}
C {launcher.sym} 5285 -1480 0 0 {name=h6
descr="View raw file"
tclcommand="textwindow $netlist_dir/template_adv_tb.raw"}
C {launcher.sym} -270 -1042.5 0 0 {name=h7 
descr="Load TRAN" 
tclcommand="
...
C {ngspice_get_expr.sym} 600 -1060 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_d)]]"
descr="vi_d="}
...
C {ammeter.sym} 340 -660 0 1 {name=vi_d}
C {devices/lab_pin.sym} -130 -660 2 0 {name=p1 lab=VREF}
C {devices/vsource.sym} -190 -600 0 0 {name=V2 value=0.65}
...
C {launcher.sym} -205 -1012.5 0 0 {name=h5
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
...
C {ngspice_get_expr.sym} 390 -1110 2 0 {name=r20 node="[to_eng [ngspice::get_value r10]]"
descr="extract="}
C {ngspice_get_expr.sym} 60 -1090 2 0 {name=r21 node="[to_eng [ngspice::get_value i(vi_d)]]"
descr="vi_d="}
...
C {devices/lab_pin.sym} -130 -810 2 0 {name=p6 lab=Vgs}
C {devices/lab_pin.sym} -190 -720 0 0 {name=p8 lab=0}
C {vsource_arith.sym} -190 -750 0 0 {name=E1 
VOL="'1+sin(time*2*pi*1e6)'"}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 230 -550 0 1 {name=M1
L=0.15
W=2
nf=1 mult=1
model=nfet_01v8_lvt
...
C {devices/lab_pin.sym} -130 -520 2 0 {name=p5 lab=VDD}
C {devices/vsource.sym} -190 -460 0 0 {name=V3 value=1.8
lab=VDD}
C {devices/lab_pin.sym} -190 -430 0 0 {name=p9 lab=0}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 320 -550 0 0 {name=M2
L=0.15
W=0.5
nf=1 mult=1
model=nfet_01v8_lvt
...
C {res.sym} 340 -470 0 0 {name=R24
value=10k
footprint=1206
device=resistor
m=1}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 230 -790 0 1 {name=M3
L=0.35
W=2
nf=1 mult=1
model=pfet_01v8_lvt
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 320 -790 0 0 {name=M4
L=0.35
W=0.5
nf=1 mult=1
model=pfet_01v8_lvt
...
C {devices/lab_pin.sym} 210 -500 0 0 {name=p2 lab=0}
C {devices/lab_pin.sym} 340 -420 0 0 {name=p7 lab=0}
C {sky130_fd_pr/cap_mim_m3_1.sym} 470 -660 0 0 {name=C1 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 470 -610 0 0 {name=p10 lab=0}
C {vsource.sym} -190 -890 0 0 {name=VIN1
value="1.8 pulse 0 1.8 100m 1n 1n 500m 1000m ac 1 0" 

}
C {devices/lab_pin.sym} -190 -860 0 0 {name=p11 lab=0}
C {devices/lab_pin.sym} -90 -920 2 0 {name=p12 lab=VDD_jump}
C {devices/lab_pin.sym} 280 -910 2 0 {name=p3 lab=VDD_jump}
