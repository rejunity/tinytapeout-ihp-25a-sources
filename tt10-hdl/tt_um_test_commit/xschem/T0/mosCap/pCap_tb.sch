...
B 2 1320 -998.203221277284 1950 -878.203221277284 {flags=graph,unlocked
...
color=16
node=vdd_jump}
B 2 1320 -830 1950 -550 {flags=graph
...
B 2 1320 -530 1950 -250 {flags=graph
...
T {Transient Analysis} 1315 -1112.5 0 0 0.6 0.6 { layer=6}
...
T {For known waveforms} 1660 -1053.203221277284 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1695 -873.203221277284 0 1 0.6 0.6 { layer=3}
...
N 150 -910 150 -890 {lab=VDD_jump}
N 150 -760 150 -740 {lab=0}
N 270 -810 500 -810 {lab=Vnbias}
N 650 -830 650 -760 {lab=#net2}
N 540 -810 550 -810 {lab=#net3}
N 550 -810 550 -780 {lab=#net3}
N 540 -780 550 -780 {lab=#net3}
N 650 -860 660 -860 {lab=VDD_jump}
N 660 -890 660 -860 {lab=VDD_jump}
N 650 -890 660 -890 {lab=VDD_jump}
N 650 -950 650 -890 {lab=VDD_jump}
N 270 -840 290 -840 {lab=Vpbias}
N 650 -760 650 -720 {lab=#net2}
N 540 -960 540 -840 {lab=VDD_jump}
N 540 -780 540 -760 {lab=#net3}
N 540 -760 540 -720 {lab=#net3}
N 540 -660 540 -640 {lab=V2}
N 410 -650 540 -650 {lab=V2}
N 290 -860 610 -860 {lab=Vpbias}
N 290 -860 290 -840 {lab=Vpbias}
N 540 -960 650 -960 {lab=VDD_jump}
N 650 -960 650 -950 {lab=VDD_jump}
N 540 -650 650 -650 {lab=V2}
N 650 -660 650 -650 {lab=V2}
N 540 -580 540 -500 {lab=0}
N 290 -720 540 -720 {lab=#net3}
N 290 -720 290 -560 {lab=#net3}
N 290 -500 290 -420 {lab=0}
...
value="0 pulse 0 1.8 100u 10u 10u 1 2 ac 1 0" 
...
C {devices/lab_pin.sym} 150 -740 0 0 {name=p3 lab=0}
C {devices/lab_pin.sym} 150 -910 0 0 {name=p5 lab=VDD_jump}
C {sky130_fd_pr/nfet_01v8.sym} 520 -810 0 0 {name=M1
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 360 -810 3 0 {name=p8 lab=Vnbias}
C {T2/biasGen/A_tt10_10nA/ibias_10nA.sym} -20 -640 0 0 {name=x1}
C {sky130_fd_pr/pfet_01v8.sym} 630 -860 0 0 {name=M55
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {devices/lab_pin.sym} 330 -860 1 0 {name=p9 lab=Vpbias}
C {ammeter.sym} 650 -690 0 0 {name=vi_pBias
}
C {devices/lab_pin.sym} 540 -960 0 0 {name=p19 lab=VDD_jump}
C {capa.sym} 540 -610 0 0 {name=C1
m=1
value=100f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 410 -650 2 1 {name=p21 lab=V2}
C {devices/lab_pin.sym} 540 -500 0 0 {name=p1 lab=0}
C {res.sym} 290 -530 0 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 290 -420 0 0 {name=p2 lab=0}
