...
S {}
E {}
B 2 1207.5 -582.5 1767.5 -252.5 {flags=graph
...
i(vi_i3)"
x1=0.18}
B 2 1207.5 -972.5 1767.5 -642.5 {flags=graph
...
node=v(vgs)
rainbow=0}
B 2 1207.5 -197.5 1767.5 132.5 {flags=graph
...
B 2 1210 177.5 1770 507.5 {flags=graph
...
B 2 1215 567.5 1775 897.5 {flags=graph
...
T {Output} 1427.5 -622.5 0 0 0.6 0.6 { layer=6}
T {Select Voltage} 1377.5 -1012.5 0 0 0.6 0.6 { layer=6}
T {Transient Analysis} 3197.5 -920 0 0 0.6 0.6 { layer=6}
T {Transconductance} 1337.5 -237.5 0 0 0.6 0.6 { layer=6}
T {Threshold Voltage} 1340 137.5 0 0 0.6 0.6 { layer=6}
T {Cox/WL = Cgg = Cgs + Cgd + Cgb} 690 -1140 0 0 0.4 0.4 {floater=true layer=3}
T {Drain-Source Transconductance} 1225 527.5 0 0 0.6 0.6 { layer=6}
N -340 -630 -340 -600 {lab=Vgs}
N -340 -630 -280 -630 {lab=Vgs}
N -340 -750 -340 -720 {lab=Vds}
N -340 -750 -280 -750 {lab=Vds}
N -340 -880 -340 -850 {lab=Vdd}
N -340 -880 -280 -880 {lab=Vdd}
N 640 -530 640 -480 {lab=0}
N 650 -560 650 -530 {lab=0}
N 640 -530 650 -530 {lab=0}
N 640 -560 650 -560 {lab=0}
N 640 -640 640 -590 {lab=#net1}
N 640 -800 640 -700 {lab=Vds}
N 540 -560 600 -560 {lab=Vgs}
...
.control
  ...
  dc vs_vds 0 0.6  0.005 vs_vgs 0 0.6 0.05
...
C {launcher.sym} -170 -1080 0 0 {name=h13
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_expr.sym} 220 200 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(v1)] - [ngspice::get_voltage v(v2)])/ [ngspice::get_voltage i(vi_s-m1)]\}]]"
descr="Drain-Source Channel Resistance M1 ="}
C {ngspice_get_expr.sym} 640 -980 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_d)]]"
descr="vi_d="}
...
C {ngspice_get_expr.sym} 180 200 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vds)] - [ngspice::get_voltage v(vds)]]\}]"
descr="Voltage lelele ="}
C {ngspice_get_value.sym} 640 -1110 0 1 {name=r2 node= @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]
descr="gm="}
C {ngspice_get_expr.sym} 120 200 2 0 {name=r1 node="[ngspice::get_node @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]]"
descr="Gm ="}
C {ngspice_get_value.sym} 70 220 0 1 {name=r3 node=@r6
descr="test="}
C {ngspice_get_value.sym} 240 200 0 0 {name=r4 node=xxx
descr="I="}
...
C {ngspice_get_value.sym} 530 -965 0 1 {name=r19 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[gds]
descr="gds="

}
C {ngspice_get_expr.sym} 270 200 2 0 {name=r20 node="[to_eng [ngspice::get_value r10]]"
descr="extract="}
C {ngspice_get_expr.sym} 20 220 2 0 {name=r21 node="[to_eng [ngspice::get_value i(vi_d)]]"
descr="vi_d="}
...
C {devices/vsource.sym} -340 -690 0 0 {name=vs_vds value=1}
C {devices/lab_pin.sym} -340 -660 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} -280 -750 2 0 {name=p3 lab=Vds}
...
C {ammeter.sym} 640 -670 0 1 {name=vi_d}
C {devices/lab_pin.sym} 540 -560 0 0 {name=p22 lab=Vgs}
C {devices/lab_pin.sym} 640 -480 0 0 {name=p23 lab=0}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 620 -560 0 0 {name=M1
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8_lvt
...
C {devices/lab_pin.sym} 640 -800 0 0 {name=p24 lab=Vds}
