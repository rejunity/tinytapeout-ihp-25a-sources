...
B 2 1040 -978.203221277284 1670 -858.203221277284 {flags=graph,unlocked
...
color=16
node=vdd_jump}
B 2 1040 -480 1670 -200 {flags=graph
...
hcursor1_y=1.975666e-07}
B 2 1040 -790 1670 -510 {flags=graph
...
B 2 1040 -180 1670 100 {flags=graph
...
T {Transient Analysis} 1035 -1092.5 0 0 0.6 0.6 { layer=6}
...
T {For known waveforms} 1380 -1033.203221277284 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1415 -853.203221277284 0 1 0.6 0.6 { layer=3}
...
T {Anch} 1685 -352.5 0 0 0.6 0.6 { layer=6}
T {Anch} 1685 -672.5 0 0 0.6 0.6 { layer=6}
T {Anch} 1685 -52.5 0 0 0.6 0.6 { layer=6}
N -210 -830 -190 -830 {lab=Vjump}
N -310 -830 -310 -790 {lab=#net1}
N -310 -680 -310 -650 {lab=Vdd}
N -310 -680 -250 -680 {lab=Vdd}
N -310 -830 -270 -830 {lab=#net1}
N 140 -640 170 -640 {lab=#net2}
N 40 -640 80 -640 {lab=Vjump}
N 230 -690 230 -670 {lab=Vp}
N 230 -610 230 -590 {lab=#net3}
N 230 -530 230 -510 {lab=Vm}
N 230 -450 230 -430 {lab=0}
N 230 -770 230 -750 {lab=#net4}
N 230 -850 230 -830 {lab=Vdd}
N 290 -640 330 -640 {lab=Vout}
N 230 -680 330 -680 {lab=Vp}
N 230 -520 330 -520 {lab=Vm}
N 330 -640 440 -640 {lab=Vout}
N 440 -640 570 -640 {lab=Vout}
C {launcher.sym} 5285 -1480 0 0 {name=h6
descr="View raw file"
tclcommand="textwindow $netlist_dir/template_adv_tb.raw"}
C {launcher.sym} -260 -1022.5 0 0 {name=h7 
descr="Load TRAN" 
tclcommand="
...
C {launcher.sym} -710 -750 0 0 {name=h13
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_expr.sym} 240 -1240 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(v1)] - [ngspice::get_voltage v(v2)])/ [ngspice::get_voltage i(vi_s-m1)]\}]]"
...
descr="vi_d="}
C {launcher.sym} -785 -790 0 0 {name=h1 
descr="Load DC" 
tclcommand="
xschem raw_read $netlist_dir/nmos_tb.raw dc
"
}
C {launcher.sym} -770 -670 0 0 {name=h2 
descr="Load AC" 
tclcommand="
xschem raw_read $netlist_dir/nmos_tb.raw ac
"
}
C {ngspice_get_expr.sym} 220 -1240 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vds)] - [ngspice::get_voltage v(vds)]]\}]"
descr="Voltage lelele ="}
C {ngspice_get_value.sym} 760 -1410 0 1 {name=r2 node= @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]
descr="gm="}
C {ngspice_get_expr.sym} 200 -1240 2 0 {name=r1 node="[ngspice::get_node @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]]"
descr="Gm ="}
C {ngspice_get_value.sym} 160 -1240 0 1 {name=r3 node=@r6
descr="test="}
C {ngspice_get_value.sym} 280 -1240 0 0 {name=r4 node=xxx
descr="I="}
...
C {launcher.sym} -745 -630 0 0 {name=h4
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {launcher.sym} -185 -992.5 0 0 {name=h5
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
...
C {ngspice_get_expr.sym} 260 -1240 2 0 {name=r20 node="[to_eng [ngspice::get_value r10]]"
descr="extract="}
C {ngspice_get_expr.sym} 180 -1240 2 0 {name=r21 node="[to_eng [ngspice::get_value i(vi_d)]]"
descr="vi_d="}
...
C {vsource.sym} -310 -760 0 0 {name=VIN1
value="Vdd pulse Vdd 0 1u 0.1n 0.1n 2.5u 5u ac 1 0" 

}
C {devices/lab_pin.sym} -310 -730 0 0 {name=p11 lab=0}
C {devices/lab_pin.sym} -190 -830 2 0 {name=p12 lab=Vjump}
C {ammeter.sym} -240 -830 3 1 {name=vi_total}
C {devices/vsource.sym} -310 -620 0 0 {name=vs_vdd value='Vdd'}
C {devices/lab_pin.sym} -310 -590 0 0 {name=p6 lab=0}
C {devices/lab_pin.sym} -250 -680 2 0 {name=p7 lab=Vdd}
C {T0/inv/inv.sym} 50 -460 0 0 {name=x4}
C {devices/lab_pin.sym} 230 -850 2 0 {name=p9 lab=Vdd}
C {lab_pin.sym} 570 -640 0 1 {name=p10 lab=Vout}
C {devices/lab_pin.sym} 230 -430 2 0 {name=p13 lab=0}
C {devices/lab_pin.sym} 40 -640 1 0 {name=p2 lab=Vjump}
C {ammeter.sym} 110 -640 3 1 {name=vi_g}
C {ammeter.sym} 230 -720 0 1 {name=vi_p}
C {ammeter.sym} 230 -560 0 1 {name=vi_n}
C {res.sym} 230 -480 0 0 {name=R24
value='Vdd/imax'
footprint=1206
device=resistor
m=1}
C {res.sym} 230 -800 0 0 {name=R25
value='Vdd/imax'
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 330 -520 2 0 {name=p1 lab=Vm}
C {devices/lab_pin.sym} 330 -680 2 0 {name=p3 lab=Vp}
