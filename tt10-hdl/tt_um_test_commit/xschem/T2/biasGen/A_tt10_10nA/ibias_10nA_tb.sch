...
N 600 -250 600 -230 {lab=#net2}
N 600 -280 610 -280 {lab=#net2}
N 610 -280 610 -250 {lab=#net2}
N 600 -250 610 -250 {lab=#net2}
N 600 -230 600 -210 {lab=#net2}
N -250 -670 -250 -640 {lab=Vdd}
N -250 -670 -190 -670 {lab=Vdd}
N -250 -820 -210 -820 {lab=#net1}
N 240 -390 250 -390 {lab=VDD_jump}
N 250 -390 250 -360 {lab=VDD_jump}
N 250 -230 250 -200 {lab=0}
N 370 -280 560 -280 {lab=V1}
N 600 -580 600 -500 {lab=VDD_jump}
N 600 -150 600 -110 {lab=#net3}
N 600 -440 600 -310 {lab=#net4}
N 370 -310 400 -310 {lab=#net5}
N 400 -470 400 -310 {lab=#net5}
N 400 -470 560 -470 {lab=#net5}
N 600 -470 610 -470 {lab=VDD_jump}
N 610 -500 610 -470 {lab=VDD_jump}
N 600 -500 610 -500 {lab=VDD_jump}
...
C {sky130_fd_pr/nfet_01v8.sym} 580 -280 0 0 {name=M1
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 600 -50 3 0 {name=p3 lab=0}
C {devices/lab_pin.sym} 240 -390 0 0 {name=p2 lab=VDD_jump}
...
C {devices/lab_pin.sym} 250 -200 0 0 {name=p1 lab=0}
C {sky130_fd_pr/res_generic_po.sym} 600 -80 0 0 {name=R24
W=1
L=1
model=res_generic_po
spiceprefix=X
 mult=1}
C {ammeter.sym} 600 -180 0 1 {name=vi_d}
C {devices/lab_pin.sym} 600 -580 0 0 {name=p4 lab=VDD_jump}
C {devices/lab_pin.sym} 500 -280 3 0 {name=p5 lab=V1}
C {T2/biasGen/A_tt10_10nA/ibias_10nA.sym} 80 -110 0 0 {name=x1}
C {sky130_fd_pr/pfet_01v8.sym} 580 -470 0 0 {name=M55
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
