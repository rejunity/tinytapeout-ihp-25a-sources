...
B 2 1430 -988.203221277284 2060 -868.203221277284 {flags=graph,unlocked
...
T {Transient Analysis} 1425 -1102.5 0 0 0.6 0.6 { layer=6}
...
T {For known waveforms} 1770 -1043.203221277284 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1805 -863.203221277284 0 1 0.6 0.6 { layer=3}
...
N 210 -750 220 -750 {lab=VDD_jump}
N 220 -750 220 -720 {lab=VDD_jump}
N 220 -590 220 -560 {lab=0}
N 710 -920 710 -840 {lab=VDD_jump}
N 710 -810 720 -810 {lab=VDD_jump}
N 720 -840 720 -810 {lab=VDD_jump}
N 710 -840 720 -840 {lab=VDD_jump}
N 710 -390 710 -370 {lab=V3}
N 710 -220 710 -200 {lab=V4}
N 710 -250 720 -250 {lab=V4}
N 720 -250 720 -220 {lab=V4}
N 710 -220 720 -220 {lab=V4}
N 710 -200 710 -180 {lab=V4}
N 580 -250 670 -250 {lab=Vnbias}
N 340 -640 360 -640 {lab=Vnbias}
N 340 -670 360 -670 {lab=Vpbias}
N 580 -810 670 -810 {lab=Vpbias}
N 710 -120 710 -90 {lab=0}
N 710 -370 710 -280 {lab=V3}
N 710 -780 710 -600 {lab=V1}
N 710 -540 710 -450 {lab=#net2}
N 1090 -920 1090 -840 {lab=VDD_jump}
N 1090 -810 1100 -810 {lab=VDD_jump}
N 1100 -840 1100 -810 {lab=VDD_jump}
N 1090 -840 1100 -840 {lab=VDD_jump}
N 1090 -390 1090 -370 {lab=V3_parax}
N 1090 -220 1090 -200 {lab=V4_parax}
N 1090 -250 1100 -250 {lab=V4_parax}
N 1100 -250 1100 -220 {lab=V4_parax}
N 1090 -220 1100 -220 {lab=V4_parax}
N 1090 -200 1090 -180 {lab=V4_parax}
N 960 -250 1050 -250 {lab=Vnbias_parax}
N 960 -810 1050 -810 {lab=Vpbias_parax}
N 1090 -120 1090 -90 {lab=0}
N 1090 -370 1090 -280 {lab=V3_parax}
N 1090 -780 1090 -600 {lab=V1_parax}
N 1090 -540 1090 -450 {lab=#net3}
N 340 -380 360 -380 {lab=Vnbias_parax}
N 340 -410 360 -410 {lab=Vpbias_parax}
N 210 -490 220 -490 {lab=VDD_jump}
N 220 -490 220 -460 {lab=VDD_jump}
N 220 -330 220 -300 {lab=0}
...
value="0 pulse 0 1.8 10m 1m 1m 10m 20m ac 1 0" 
...
C {devices/lab_pin.sym} 210 -750 0 0 {name=p2 lab=VDD_jump}
C {devices/lab_pin.sym} 220 -560 0 0 {name=p1 lab=0}
C {ammeter.sym} 710 -570 0 1 {name=vi_d}
C {devices/lab_pin.sym} 710 -920 2 0 {name=p4 lab=VDD_jump}
C {T2/biasGen/A_tt10_10nA/ibias_10nA.sym} 50 -470 0 0 {name=x1}
C {sky130_fd_pr/pfet_01v8.sym} 690 -810 0 0 {name=M55
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {res.sym} 710 -420 0 0 {name=R25
value=10k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 360 -670 0 1 {name=p8 lab=Vpbias}
C {devices/lab_pin.sym} 360 -640 0 1 {name=p9 lab=Vnbias}
C {devices/lab_pin.sym} 710 -740 2 0 {name=p5 lab=V1}
C {sky130_fd_pr/nfet_01v8.sym} 690 -250 0 0 {name=M2
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {ammeter.sym} 710 -150 0 1 {name=vi_d1}
C {devices/lab_pin.sym} 710 -370 2 0 {name=p13 lab=V3}
C {devices/lab_pin.sym} 710 -180 2 0 {name=p14 lab=V4}
C {devices/lab_pin.sym} 580 -250 0 0 {name=p3 lab=Vnbias}
C {devices/lab_pin.sym} 580 -810 0 0 {name=p16 lab=Vpbias}
C {devices/lab_pin.sym} 710 -90 0 0 {name=p18 lab=0}
C {ammeter.sym} 1090 -570 0 1 {name=vi_d_parax}
C {devices/lab_pin.sym} 1090 -920 2 0 {name=p6 lab=VDD_jump}
C {sky130_fd_pr/pfet_01v8.sym} 1070 -810 0 0 {name=M1
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {res.sym} 1090 -420 0 0 {name=R24
value=10k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 1090 -740 2 0 {name=p7 lab=V1_parax}
C {sky130_fd_pr/nfet_01v8.sym} 1070 -250 0 0 {name=M3
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {ammeter.sym} 1090 -150 0 1 {name=vi_d3}
C {devices/lab_pin.sym} 1090 -370 2 0 {name=p10 lab=V3_parax}
C {devices/lab_pin.sym} 1090 -180 2 0 {name=p15 lab=V4_parax}
C {devices/lab_pin.sym} 1090 -90 0 0 {name=p20 lab=0}
C {devices/lab_pin.sym} 360 -410 0 1 {name=p21 lab=Vpbias_parax}
C {devices/lab_pin.sym} 360 -380 0 1 {name=p22 lab=Vnbias_parax}
C {devices/lab_pin.sym} 210 -490 0 0 {name=p23 lab=VDD_jump}
C {devices/lab_pin.sym} 220 -300 0 0 {name=p24 lab=0}
C {devices/lab_pin.sym} 960 -810 2 1 {name=p19 lab=Vpbias_parax}
C {devices/lab_pin.sym} 960 -250 2 1 {name=p17 lab=Vnbias_parax}
C {T2/biasGen/A_tt10_10nA/ibias_10nA_parax.sym} 50 -210 0 0 {name=x2}
