...
N 220 -1010 220 -940 {lab=Vdd}
N 150 -940 220 -940 {lab=Vdd}
N 150 -940 150 -920 {lab=Vdd}
N 220 -940 280 -940 {lab=Vdd}
N 280 -940 280 -920 {lab=Vdd}
N 190 -890 240 -890 {lab=V1}
N 280 -890 290 -890 {lab=Vdd}
N 290 -920 290 -890 {lab=Vdd}
N 280 -920 290 -920 {lab=Vdd}
N 140 -890 150 -890 {lab=Vdd}
N 140 -920 140 -890 {lab=Vdd}
N 140 -920 150 -920 {lab=Vdd}
...
N -220 -680 -220 -650 {lab=Vdd}
N -220 -680 -160 -680 {lab=Vdd}
N 260 -290 260 -260 {lab=0}
N 260 -260 280 -260 {lab=0}
N 280 -260 280 -250 {lab=0}
...
value="0.6 pulse 0 0.6 2 1n 1n 10 20 ac 1 0" 
...
C {devices/lab_pin.sym} 280 -250 0 0 {name=p5 lab=0}
...
C {sky130_fd_pr/pfet_01v8.sym} 170 -890 0 1 {name=M3
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 260 -890 0 0 {name=M4
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 170 -560 0 1 {name=M1
L=1
W=3
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 260 -560 0 0 {name=M2
L=1
W=3
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 640 -560 0 0 {name=M5
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/res_generic_po.sym} 660 -290 0 0 {name=R24
W=1
L=1
model=res_generic_po
spiceprefix=X
 mult=1}
C {devices/vsource.sym} -220 -620 0 0 {name=vs_vdd value=0.6}
C {devices/lab_pin.sym} -220 -590 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} -160 -680 2 0 {name=p4 lab=Vdd}
C {devices/lab_pin.sym} 220 -1010 2 0 {name=p3 lab=Vdd}
C {devices/lab_pin.sym} 660 -640 2 0 {name=p6 lab=Vdd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 280 -290 0 0 {name=R25
W=0.35
L=10
