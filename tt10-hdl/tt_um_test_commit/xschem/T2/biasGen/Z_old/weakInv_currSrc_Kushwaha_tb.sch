...
S {}
E {}
B 2 -480 -540 -343 -480 {flags=image
alpha=0.6
InvertOnExport=true
...
B 2 940 -998.203221277284 1570 -878.203221277284 {flags=graph,unlocked
...
color=16
node=vdd_jump}
B 2 940 -830 1570 -550 {flags=graph
...
B 2 940 -530 1570 -250 {flags=graph
...
T {Transient Analysis} 935 -1112.5 0 0 0.6 0.6 { layer=6}
...
T {Vds: @spice_get_voltage(vds)\\V} 240 -1440 0 0 0.4 0.4 {floater=true layer=3}
T {			Circuit Information
__________________________________________________} 340 -1580 0 0 0.4 0.4 { layer=3
}
T {For known waveforms} 1280 -1053.203221277284 0 1 0.6 0.6 { layer=3}
T {For intesting waveforms} 1315 -873.203221277284 0 1 0.6 0.6 { layer=3}
...
T {	   Xschem
______________________} 220 -1510 0 0 0.4 0.4 { layer=3
}
N -150 -820 -130 -820 {lab=VDD_jump}
N -250 -820 -250 -780 {lab=#net1}
N 410 -920 410 -900 {lab=VDD_jump}
N 540 -920 540 -900 {lab=VDD_jump}
N 450 -870 500 -870 {lab=Vpbias}
N 540 -870 550 -870 {lab=VDD_jump}
N 550 -900 550 -870 {lab=VDD_jump}
N 540 -900 550 -900 {lab=VDD_jump}
N 400 -870 410 -870 {lab=VDD_jump}
N 400 -900 400 -870 {lab=VDD_jump}
N 400 -900 410 -900 {lab=VDD_jump}
N 540 -840 540 -810 {lab=#net2}
N 410 -840 410 -820 {lab=Vpbias}
N 410 -820 410 -810 {lab=Vpbias}
N 410 -810 410 -790 {lab=Vpbias}
N 540 -740 540 -720 {lab=Vnbias}
N 460 -870 460 -830 {lab=Vpbias}
N 410 -810 460 -810 {lab=Vpbias}
N 460 -830 460 -810 {lab=Vpbias}
N 450 -650 500 -650 {lab=Vnbias}
N 410 -620 410 -600 {lab=#net3}
N 540 -620 540 -600 {lab=0}
N 400 -650 410 -650 {lab=#net3}
N 400 -650 400 -620 {lab=#net3}
N 400 -620 410 -620 {lab=#net3}
N 540 -650 550 -650 {lab=0}
N 550 -650 550 -620 {lab=0}
N 540 -620 550 -620 {lab=0}
N 540 -600 540 -580 {lab=0}
N 480 -700 480 -650 {lab=Vnbias}
N 410 -600 410 -590 {lab=#net3}
N 410 -590 410 -580 {lab=#net3}
N 540 -720 540 -680 {lab=Vnbias}
N 480 -710 480 -700 {lab=Vnbias}
N 480 -710 540 -710 {lab=Vnbias}
N 540 -810 540 -800 {lab=#net2}
N 220 -870 230 -870 {lab=VDD_jump}
N 220 -900 220 -870 {lab=VDD_jump}
N 220 -900 230 -900 {lab=VDD_jump}
N 230 -620 240 -620 {lab=#net3}
N 240 -620 240 -590 {lab=#net3}
N 230 -590 240 -590 {lab=#net3}
N 230 -540 240 -540 {lab=0}
N 240 -540 240 -510 {lab=0}
N 230 -510 240 -510 {lab=0}
N 230 -510 230 -490 {lab=0}
N 230 -490 230 -480 {lab=0}
N 170 -540 190 -540 {lab=V2}
N 170 -620 190 -620 {lab=V2}
N 170 -670 230 -670 {lab=V2}
N 410 -920 540 -920 {lab=VDD_jump}
N 230 -920 410 -920 {lab=VDD_jump}
N 400 -810 410 -810 {lab=Vpbias}
N 270 -870 320 -870 {lab=Vpbias}
N 320 -870 320 -810 {lab=Vpbias}
N 320 -810 400 -810 {lab=Vpbias}
N 170 -670 170 -540 {lab=V2}
N 230 -590 230 -570 {lab=#net3}
N 230 -670 230 -650 {lab=V2}
N 230 -580 410 -580 {lab=#net3}
N 230 -780 230 -670 {lab=V2}
N 230 -920 230 -900 {lab=VDD_jump}
N 40 -920 170 -920 {lab=VDD_jump}
N 230 -840 230 -780 {lab=V2}
N -250 -670 -250 -640 {lab=Vdd}
N -250 -670 -190 -670 {lab=Vdd}
N -250 -820 -210 -820 {lab=#net1}
N 10 -920 40 -920 {lab=VDD_jump}
N 170 -920 230 -920 {lab=VDD_jump}
N 410 -730 410 -680 {lab=Vpbias}
N 410 -790 410 -730 {lab=Vpbias}
N 770 -680 770 -660 {lab=0}
N 770 -710 780 -710 {lab=0}
N 780 -710 780 -680 {lab=0}
N 770 -680 780 -680 {lab=0}
N 770 -660 770 -640 {lab=0}
N 770 -780 770 -740 {lab=#net4}
N 540 -710 730 -710 {lab=Vnbias}
N 770 -1010 770 -930 {lab=Vdd}
N 770 -870 770 -840 {lab=#net5}
C {launcher.sym} 5285 -1480 0 0 {name=h6
descr="View raw file"
tclcommand="textwindow $netlist_dir/template_adv_tb.raw"}
C {launcher.sym} -300 -1062.5 0 0 {name=h7 
descr="Load TRAN" 
tclcommand="
xschem raw_read $netlist_dir/nmos_tb_tran.raw tran
"
}
...
.control
  ...
  *dc v_dev_vds 0 1.8 0.005 v_dev_vgs 0 1.8 0.2 
  *write nmos_tb.raw
...
C {launcher.sym} -920 -910 0 0 {name=h13
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_expr.sym} 130 -1190 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(v1)] - [ngspice::get_voltage v(v2)])/ [ngspice::get_voltage i(vi_s-m1)]\}]]"
descr="Drain-Source Channel Resistance M1 ="}
C {ngspice_get_expr.sym} 600 -1190 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_d)]]"
descr="vi_d="}
...
C {ngspice_get_expr.sym} 110 -1190 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vds)] - [ngspice::get_voltage v(vds)]]\}]"
descr="Voltage lelele ="}
C {ngspice_get_value.sym} 760 -1410 0 1 {name=r2 node= @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]
descr="gm="}
C {ngspice_get_expr.sym} 90 -1190 2 0 {name=r1 node="[ngspice::get_node @m.xm1.msky130_fd_pr__nfet_01v8_lvt[gm]]"
descr="Gm ="}
C {ngspice_get_value.sym} 50 -1190 0 1 {name=r3 node=@r6
descr="test="}
C {ngspice_get_value.sym} 170 -1190 0 0 {name=r4 node=xxx
descr="I="}
C {ngspice_get_value.sym} 650 -1360 0 1 {name=r5 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[vgs])
descr="vgs="

}
C {ngspice_get_value.sym} 980 -1420 0 1 {name=r9 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgg]
descr="cgg="

}
C {ngspice_get_value.sym} 650 -1310 0 1 {name=r10 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[vds])
descr="vds="

}
C {ngspice_get_value.sym} 760 -1310 0 1 {name=r11 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[vdsat])
descr="vdsat="

}
C {ngspice_get_value.sym} 980 -1380 0 1 {name=r12 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgs]
descr="cgs="

}
C {ngspice_get_value.sym} 980 -1350 0 1 {name=r13 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgdo]
descr="cgdo="

}
C {ngspice_get_value.sym} 980 -1320 0 1 {name=r14 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgb]
descr="cgb="

}
C {launcher.sym} 610 -1480 0 0 {name=h3
descr="List of all known ngspice attributes"
url="https://ngspice.sourceforge.io/docs/ngspice-manual.pdf#page=703"}
C {ngspice_get_value.sym} 650 -1410 0 1 {name=r15 node=i(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[id])
descr="id="

}
C {ngspice_get_value.sym} 760 -1360 0 1 {name=r16 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[vth])
descr="vth="
...
C {launcher.sym} -225 -1032.5 0 0 {name=h5
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {ngspice_get_value.sym} 1330 -1410 0 1 {name=r17 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[leff])
descr="effective length="

}
C {ngspice_get_value.sym} 1330 -1370 0 1 {name=r18 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[weff])
descr="effective width="

}
C {ngspice_get_value.sym} 760 -1260 0 1 {name=r19 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[gds]
descr="gds="

}
C {ngspice_get_expr.sym} 150 -1190 2 0 {name=r20 node="[to_eng [ngspice::get_value r10]]"
descr="extract="}
C {ngspice_get_expr.sym} 70 -1190 2 0 {name=r21 node="[to_eng [ngspice::get_value i(vi_d)]]"
descr="vi_d="}
C {ngspice_get_value.sym} 1200 -1410 0 1 {name=r22 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[l])
descr="length="

}
C {ngspice_get_value.sym} 1200 -1370 0 1 {name=r23 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[w])
descr="width="

}
C {vsource.sym} -250 -750 0 0 {name=VIN1
value="0 pulse 0 1.8 10m 1m 1m 100m 200m ac 1 0" 

}
C {devices/lab_pin.sym} -250 -720 0 0 {name=p11 lab=0}
C {devices/lab_pin.sym} -130 -820 2 0 {name=p12 lab=VDD_jump}
C {ammeter.sym} -180 -820 3 1 {name=vi_total}
C {sky130_fd_pr/pfet_01v8.sym} 430 -870 0 1 {name=M17
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 520 -870 0 0 {name=M3
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 250 -870 0 1 {name=M5
L=0.30
W=2
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 430 -650 0 1 {name=M2
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 520 -650 0 0 {name=M1
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 540 -580 3 0 {name=p3 lab=0}
C {devices/lab_pin.sym} 460 -820 2 0 {name=p4 lab=Vpbias}
C {devices/lab_pin.sym} 480 -710 0 0 {name=p13 lab=Vnbias}
C {sky130_fd_pr/nfet_01v8.sym} 210 -620 0 0 {name=M6
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 210 -540 0 0 {name=M7
L=1
W=1
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 230 -480 3 0 {name=p1 lab=0}
C {devices/lab_pin.sym} 10 -920 0 0 {name=p2 lab=VDD_jump}
C {devices/lab_pin.sym} 170 -590 0 1 {name=p5 lab=V2}
C {ammeter.sym} 540 -770 0 1 {name=vi_d}
...
C {sky130_fd_pr/nfet_01v8.sym} 750 -710 0 0 {name=M8
L=0.2
W=1
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 770 -640 3 0 {name=p9 lab=0}
C {devices/lab_pin.sym} 770 -1010 2 0 {name=p10 lab=Vdd}
C {sky130_fd_pr/res_generic_po.sym} 770 -900 0 0 {name=R24
W=1
L=1
model=res_generic_po
spiceprefix=X
 mult=1}
C {ammeter.sym} 770 -810 0 1 {name=vi_d1}
