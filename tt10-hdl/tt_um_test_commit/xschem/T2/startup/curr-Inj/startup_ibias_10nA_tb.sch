...
N 470 -840 480 -840 {lab=VDD_jump}
N 480 -870 480 -840 {lab=VDD_jump}
N 470 -870 480 -870 {lab=VDD_jump}
N 270 -840 290 -840 {lab=Vpbias}
N 470 -730 470 -710 {lab=V2}
N 290 -860 290 -840 {lab=Vpbias}
N 470 -650 470 -570 {lab=0}
N 290 -840 330 -840 {lab=Vpbias}
N 470 -900 470 -870 {lab=VDD_jump}
N 470 -810 470 -790 {lab=#net2}
N 470 -720 550 -720 {lab=V2}
N 410 -840 430 -840 {lab=#net3}
N 330 -840 350 -840 {lab=Vpbias}
...
C {sky130_fd_pr/pfet_01v8.sym} 450 -840 0 0 {name=M55
L=0.35
W=1
nf=1 mult=1
model=pfet_01v8
...
C {devices/lab_pin.sym} 290 -860 1 0 {name=p9 lab=Vpbias}
C {ammeter.sym} 470 -760 0 0 {name=vi_pBias
}
C {devices/lab_pin.sym} 470 -900 0 1 {name=p19 lab=VDD_jump}
C {capa.sym} 470 -680 0 0 {name=C1
m=1
value=100f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 470 -570 0 0 {name=p1 lab=0}
C {devices/lab_pin.sym} 550 -720 2 0 {name=p2 lab=V2}
C {ammeter.sym} 380 -840 3 0 {name=vi_pBias1
}
