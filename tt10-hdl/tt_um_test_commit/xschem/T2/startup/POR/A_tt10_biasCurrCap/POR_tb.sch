...
N -180 -860 -160 -860 {lab=VDD_jump}
N -280 -860 -280 -820 {lab=#net1}
N -280 -710 -280 -680 {lab=Vdd}
N -280 -710 -220 -710 {lab=Vdd}
N -280 -860 -240 -860 {lab=#net1}
N 350 -320 360 -320 {lab=0}
N 350 -320 350 -290 {lab=0}
N 350 -290 360 -290 {lab=0}
N 360 -290 360 -250 {lab=0}
N 360 -410 360 -350 {lab=V5}
N 400 -370 400 -320 {lab=V5}
N 360 -370 400 -370 {lab=V5}
N 350 -440 360 -440 {lab=V5}
N 350 -440 350 -410 {lab=V5}
N 350 -410 360 -410 {lab=V5}
N 360 -530 360 -470 {lab=V4}
N 400 -490 400 -440 {lab=V4}
N 360 -490 400 -490 {lab=V4}
N 350 -560 360 -560 {lab=V4}
N 350 -560 350 -530 {lab=V4}
N 350 -530 360 -530 {lab=V4}
N 400 -610 400 -560 {lab=V3}
N 360 -610 400 -610 {lab=V3}
N 320 -700 320 -670 {lab=V3}
N 360 -700 370 -700 {lab=V2}
N 370 -730 370 -700 {lab=V2}
N 360 -730 370 -730 {lab=V2}
N 360 -780 360 -730 {lab=V2}
N 320 -670 360 -670 {lab=V3}
N 320 -810 320 -780 {lab=V2}
N 360 -810 370 -810 {lab=V1}
N 370 -840 370 -810 {lab=V1}
N 360 -840 370 -840 {lab=V1}
N 360 -890 360 -840 {lab=V1}
N 320 -780 360 -780 {lab=V2}
N 320 -920 320 -890 {lab=V1}
N 360 -920 370 -920 {lab=VDD_jump}
N 370 -950 370 -920 {lab=VDD_jump}
N 360 -950 370 -950 {lab=VDD_jump}
N 360 -1000 360 -950 {lab=VDD_jump}
N 320 -890 360 -890 {lab=V1}
N 360 -1020 360 -1000 {lab=VDD_jump}
N 360 -610 360 -590 {lab=V3}
N 360 -750 550 -750 {lab=V2}
N 360 -860 550 -860 {lab=V1}
N 360 -640 550 -640 {lab=V3}
N 360 -510 550 -510 {lab=V4}
N 360 -390 550 -390 {lab=V5}
N 360 -670 360 -620 {lab=V3}
N 360 -620 360 -610 {lab=V3}
C {launcher.sym} 5285 -1480 0 0 {name=h6
descr="View raw file"
tclcommand="textwindow $netlist_dir/template_adv_tb.raw"}
C {launcher.sym} -310 -1062.5 0 0 {name=h7 
descr="Load TRAN" 
tclcommand="
...
C {ngspice_get_expr.sym} 470 -950 2 1 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(vdd_jump)] - [ngspice::get_voltage v(v1)])\}]]"
descr="Vf_D1="}
...
C {launcher.sym} -235 -1032.5 0 0 {name=h5
descr="Live annotate" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
...
C {vsource.sym} -280 -790 0 0 {name=VIN1
value="0 pulse 0 1.8 10n 1n 1n 100m 200m ac 1 0" 

}
C {devices/lab_pin.sym} -280 -760 0 0 {name=p11 lab=0}
C {devices/lab_pin.sym} -160 -860 2 0 {name=p12 lab=VDD_jump}
C {ammeter.sym} -210 -860 3 1 {name=vi_total}
C {devices/vsource.sym} -280 -650 0 0 {name=vs_vdd value=1.8}
C {devices/lab_pin.sym} -280 -620 0 0 {name=p6 lab=0}
C {devices/lab_pin.sym} -220 -710 2 0 {name=p7 lab=Vdd}
C {devices/lab_pin.sym} 360 -1020 2 0 {name=p4 lab=VDD_jump}
C {sky130_fd_pr/nfet_01v8.sym} 380 -320 0 1 {name=M1
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 340 -700 0 0 {name=M3
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {devices/lab_pin.sym} 360 -250 0 0 {name=p8 lab=0}
C {sky130_fd_pr/nfet_01v8.sym} 380 -440 0 1 {name=M4
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 380 -560 0 1 {name=M5
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 340 -810 0 0 {name=M6
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 340 -920 0 0 {name=M7
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {devices/lab_pin.sym} 550 -750 2 0 {name=p1 lab=V2}
C {devices/lab_pin.sym} 550 -860 2 0 {name=p2 lab=V1}
C {devices/lab_pin.sym} 550 -640 0 1 {name=p3 lab=V3}
C {devices/lab_pin.sym} 550 -510 0 1 {name=p5 lab=V4}
C {devices/lab_pin.sym} 550 -390 0 1 {name=p9 lab=V5}
C {ngspice_get_expr.sym} 470 -830 2 1 {name=r24 node="[to_eng [expr \{([ngspice::get_voltage v(v1)] - [ngspice::get_voltage v(v2)])\}]]"
descr="Vf_D2="}
C {ngspice_get_expr.sym} 470 -720 2 1 {name=r25 node="[to_eng [expr \{([ngspice::get_voltage v(v2)] - [ngspice::get_voltage v(v3)])\}]]"
descr="Vf_D3="}
C {ngspice_get_expr.sym} 470 -590 2 1 {name=r26 node="[to_eng [expr \{([ngspice::get_voltage v(v3)] - [ngspice::get_voltage v(v4)])\}]]"
descr="Vf_D4="}
C {ngspice_get_expr.sym} 470 -470 2 1 {name=r27 node="[to_eng [expr \{([ngspice::get_voltage v(v4)] - [ngspice::get_voltage v(v5)])\}]]"
descr="Vf_D5="}
C {ngspice_get_expr.sym} 470 -350 2 1 {name=r28 node="[to_eng [expr \{([ngspice::get_voltage v(v5)])\}]]"
descr="Vf_D5="}
