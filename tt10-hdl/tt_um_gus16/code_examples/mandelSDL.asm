...
DELTA=  8
pstart:
		;ldi 	r7,0	; Puntero de Pila al final de RAM
		;subi	r7,1
		ldpc	r7
		word	0x7fff
		...
		jal		cmd
		ldi		r0,2		; cambio a texto
		jal		cmd

restart:
		ldpc	r0			; Texto inicio 
		word	txt1
		jal		putsle	

		ldi		r0,3		; cambio a gráficos
		jal		cmd
...
;---------------------------------------------------
; Envía dato con "stuffing"

putch_stuff:
		cmpi	r0,0xFA
		jnz		putch
		subi	r7,1		; 0xFA se manda por duplicado
		st		(r7),r6
		jal		putch		; putch no cambia R0
		ld		r6,(r7)
		addi	r7,1
		jr		putch

;---------------------------------------------------
; Envía comando gráfico
; R0: comando
